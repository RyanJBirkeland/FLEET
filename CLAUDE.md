...
- **Coverage thresholds (ratcheted 2026-03-24)**: 72% stmts, 65% branches, 69% functions, 73% lines. Configured in `vitest.config.ts`. Enforced by `npm run test:coverage` in CI. Ratchet up after adding tests — never lower.
