...
- **IPC**: 23 handler modules in `src/main/handlers/`, registered in `src/main/index.ts`, preload bridge in `src/preload/index.ts`. ~138 typed channels in `src/shared/ipc-channels.ts`.
