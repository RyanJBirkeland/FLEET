...
/**
 * Shared hook for review action logic used by both ReviewActions and TopBar components.
 * Encapsulates all IPC calls, state management, and error handling for the six review actions.
 */
